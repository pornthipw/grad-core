...
function BibTexCreateController($scope,GradDB,RegDB, 
  ...
  entry_fields_default =  {
    ...
    'pages':JSON.stringify({'display':{'th':'เลขหน้าที่ตีพิมพ์','en':'Pages'},'num':8}),
    'volume':JSON.stringify({'display':{'th':'เล่มที่','en':'Volume'},'num':6}),
    'number':JSON.stringify({'display':{'th':'เลขที่ประจำฉบับ','en':'Number'},'num':7}),
    'address':JSON.stringify({'display':{'th':'สถานที่ตีพิมพ์/สถานที่จัดงาน','en':'Address'},'num':9}),
